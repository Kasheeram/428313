...
class MotherInfoCell: CollectionBaseCell {
    
    lazy var motherNameTextFiled:UITextField = {
        let textField = UITextField()
        textField.tag = 109
        textField.setTextFiledProperties(placeHolder:"Mother Name *")
    ...
    func setupUI(){
        ...
        [motherNameTextFiled, occupationTextFiled, emailTextFiled, countryCodeTextFiled, phoneTextFiled, addressTextFiled, cityTextFiled, pinTextFiled].forEach({ addSubview($0) })
        
        motherNameTextFiled.anchor(top: topAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, size: .init(width: 0, height: 44))
        
        occupationTextFiled.anchor(top: motherNameTextFiled.bottomAnchor, leading: leadingAnchor, bottom: nil, trailing: trailingAnchor, padding: .init(top: 16, left: 0, bottom: 0, right: 0),size: .init(width: 0, height: 44))
